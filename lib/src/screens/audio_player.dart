...
class _HomeState extends State<Home> {
  ...
  Future<void> _playAudio() async {
    if (audioPlayer.state == PlayerState.PLAYING) {
      ...
      AudioPlayer audioPlayer = await audioCache.play('meditation/amitabh.mp3');
    }
  }
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: ClipOval(
                              clipper: MClipper(),
                              child: Image.asset(
                                "assets/audio_player/justine.jpg",
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
                  ...
                  children: <Widget>[
                    ...
                    Center(
                      child: Column(
                        ...
                        children: <Widget>[
                          song("assets/audio_player/cover_01.jpg", "Never say",
                              "Believe 2012"),
                          song("assets/audio_player/cover_02.jpg", "Beauty...",
                              "Believe 2012"),
                          song("assets/audio_player/cover_03.png", "Boyfriend",
                              "Believe 2012"),
                        ],
                      ),
                    )
