...
class _ProfilePageState extends State<ProfilePage> {
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          //       onPressed: () {},
          //     )),
          // buildUserInfoDisplay("Hi", 'Name', EditNameFormPage()),
          // buildUserInfoDisplay("Hi", 'Phone', EditPhoneFormPage()),
          // buildUserInfoDisplay("Hi", 'Email', EditEmailFormPage()),
          // Expanded(
  ...
  Widget buildAbout(String id) => Padding(
      padding: EdgeInsets.only(bottom: 10),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
